intrinsic find_onedimchar(f :: RngUPolElt, ell :: RngIntElt : radical_cond := 1, primes_bound := 400, charpols := [], unramified := true, useinertFrobsq := true, Hecke_stricteval := false, uselambdacharpols := false) -> SeqEnum, SeqEnum, SeqEnum
...
/*
test polys:
12*x^4 + 8*x^3 - 48*x^2 + 36*x - 7,
625*x^4 + 550*x^3 + 126*x^2 - 28*x - 4
*/
    SetColumns(0);
    Z := Integers();
...
*/
    ...
    while #X gt 0 do
        ...
        //printf "the prime %o is %o in F_%o", p, P_ell!p, ell;
